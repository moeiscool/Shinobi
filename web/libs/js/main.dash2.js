...
//                tmp+='<div class="hud super-center"><div class="top_bar"><span class="badge badge-sm badge-danger"><i class="fa fa-eye"></i> <span class="viewers"></span></span></div><div class="bottom_bar"></div></div></div></div>';
                ...
                tmp+='<div class="indifference"><div class="progress"><div class="progress-bar progress-bar-danger" role="progressbar"></div></div><div class="popover fade bottom in" role="tooltip"><div class="arrow"></div><div class="popover-content"></div></div></div>';
    ...
    switch(d.f){
        ...
        case'detector_trigger':
            ...
            if($.ccio.mon[d.id]&&d.e.length>0){
                ...
                d.e.find('.indifference .popover-content').text(d.details.confidence)
            }
        break;
