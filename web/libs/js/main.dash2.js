...
//                tmp+='<div class="hud super-center"><div class="top_bar"><span class="badge badge-sm badge-danger"><i class="fa fa-eye"></i> <span class="viewers"></span></span></div><div class="bottom_bar"></div></div></div></div>';
                ...
                tmp+='<button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">';
                tmp+='<i class="material-icons" role="presentation">more_vert</i>';
                tmp+='<span class="visuallyhidden">show menu</span>';
                tmp+='</button>';
                tmp+='</div>';
                tmp+='</div>';
                tmp+='</div>';
