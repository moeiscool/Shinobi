...
SHINOBI_ADMIN_PASSWORD_MD5=$(echo -n "${SHINOBI_ADMIN_PASSWORD}" | md5sum | sed -e 's/  -$//')
...
sed -i -e "s/21232f297a57a5a743894a0e4a801fc3/${SHINOBI_ADMIN_PASSWORD_MD5}/" "/opt/shinobi/super.json"
