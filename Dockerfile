...
RUN "debconf-set-selections <<< 'mysql-server mysql-server/root_password password night'"
RUN "debconf-set-selections <<< 'mysql-server mysql-server/root_password_again password night'"
